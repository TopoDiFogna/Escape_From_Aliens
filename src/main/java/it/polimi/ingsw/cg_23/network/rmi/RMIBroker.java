...
public class RMIBroker implements RMIBrokerInterface {
    ...
    /**
     * Sends a message to all subscribers This is not a remote method, however
     * it calls the remote method dispatchMessage for each Subscriber.
     * 
    ...
    /**
     * The method updates the list of subscriber interfaces that are subscribed
     * to the broker
     */
    @Override
