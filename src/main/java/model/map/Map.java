...
import model.map.SectorAlien;
import model.map.SectorDangerous;
import model.map.SectorEscapeHatch;
import model.map.SectorHuman;
import model.map.SectorSecure;
import model.map.SectorVoid;
